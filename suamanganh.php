<?php 
	...
	if (isset($_GET['Manganh'])) {
		...
		$sql1="SELECT * FROM nganhhoc WHERE Manganh='$Manganh'";
	...
	if (isset($_POST['btnsua'])) {
		...
		$sql="UPDATE nganhhoc SET Tennganh='$Tennganh' where Manganh='$Manganh'";
		...
		<div class="aside">
            ...
            <tr>
                <td colspan="2" style="text-align: center;"> 
                    <h3>THÔNG TIN SỬA NGÀNH HỌC</h3>
                </td>
            </tr>
            <tr>
                <td class="col1">
                    Mã ngành</td>
                <td class="col2"><input class="dd1" type = "text" name= "txtmanganh" value="<?php echo $Manganh ?>" ></td>
            </tr>
            <tr>
                <td class="col1">
                    Tên ngành
                </td>
<td class="col2"><input class= "dd1" type = "text" name= "txttennganh" value="<?php echo $Tennganh ?>"></td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: center;">
